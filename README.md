...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-cell-29c7
```

A live public deployment of this template is available at [https://winter-cell-29c7.templates.workers.dev](https://winter-cell-29c7.templates.workers.dev)
